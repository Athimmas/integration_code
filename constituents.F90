...
! Public data
  ...
  !DIR$ attributes offload:mic :: cnst_name
...
! Constants for each tracer
  ...
  !DIR$ attributes offload:mic :: cnst_type
  ...
  !DIR$ attributes offload:mic :: qmin
...
!==============================================================================
  !DIR$ ATTRIBUTES OFFLOAD : mic :: cnst_get_ind
...
!==============================================================================================
              !DIR$ ATTRIBUTES OFFLOAD : mic :: cnst_get_type_byind
