...
!DIR$ attributes offload:mic :: plenest,estbl,omeps,c3
  integer, public :: plenest                             ! length of estbl

  real(r8), public, allocatable :: estbl(:)              ! table values of saturation vapor pressure

  real(r8), public :: omeps      ! 1.0_r8 - epsilo

  real(r8), public :: c3         ! parameter used by findsp
  ...
  !DIR$ attributes offload:mic :: pcf
  real(r8), public :: pcf(5) = (/ &
...
! in the table (estbl).
!DIR$ ATTRIBUTES OFFLOAD : mic :: estblf
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: tq_enthalpy
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: no_ip_hltalt
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: calc_hltalt
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: deriv_outputs
...
!---------------------------------------------------------------------
!DIR$ ATTRIBUTES OFFLOAD : mic :: qmmr
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: qsat
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: qsat_water
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: findsp_vc
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: findsp_vc_mod
subroutine findsp_vc_mod(q, t, p, use_ice, tsp, qsp)
...
end subroutine findsp_vc_mod


!DIR$ ATTRIBUTES OFFLOAD : mic :: findsp
