...
!DIR$ attributes offload:mic :: tmelt
real(r8), public :: tmelt   ! Melting point of water at 1 atm (K)
real(r8) :: h2otrip ! Triple point temperature of water (K)
!DIR$ attributes offload:mic :: tboil
real(r8), public :: tboil   ! Boiling point of water at 1 atm (K)

real(r8) :: ttrice  ! Ice-water transition range
!DIR$ attributes offload:mic :: epsilo
real(r8), public :: epsilo  ! Ice-water transition range
!DIR$ attributes offload:mic :: omeps
real(r8), public :: omeps   ! 1._r8 - epsilo
...
!DIR$ attributes offload:mic :: default_idx
integer, public :: default_idx = initial_default_idx
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: wv_sat_svp_to_qsat
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: wv_sat_svp_to_qmmr
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: wv_sat_qsat_water
...
!---------------------------------------------------------------------
!DIR$ ATTRIBUTES OFFLOAD : mic :: wv_sat_svp_water
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: GoffGratch_svp_water
...
! Murphy & Koop (2005)
!DIR$ ATTRIBUTES OFFLOAD : mic :: MurphyKoop_svp_water
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: wv_sat_dummySubroutine
subroutine wv_sat_dummySubroutine()
    write(iulog,*) 'The values are',tboil,epsilo
end subroutine wv_sat_dummySubroutine

!DIR$ ATTRIBUTES OFFLOAD : mic :: OldGoffGratch_svp_water
...
!DIR$ ATTRIBUTES OFFLOAD : mic :: Bolton_svp_water
